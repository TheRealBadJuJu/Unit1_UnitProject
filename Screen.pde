class Screen
{
  ...
  void deathScreen()
  {
    ...
    fill(255, 0, 0);
    textSize(50);
    switch(randomInsultDeath)
    {
    case 0:
      InsultDeath = "You died, I'm proud, JK";
      break;
    ...
    case 2:
      InsultDeath = "Good running...";
      break;

    case 3:
      InsultDeath = "It's only 150 enemies...";
      break;

    case 4:
      InsultDeath = "My grandma can run faster...";
      break;
    ...
    case 6:
      InsultDeath = "Is it really that hard?";
      break;

    case 7:
      InsultDeath = "Can't be that hard...";
      break;

    case 8:
      InsultDeath = "lol you died";
      break;

    default:
      break;
    }
    text(InsultDeath, width/2, height/2-300);
    textSize(25);
  ...
  void lvlcomplete()
  {
    ...
    fill(255, 0, 0);
    textSize(50);
    switch(randomInsultCom)
    {
    case 0:
      InsultCom = "Can’t be that hard if YOU completed it";
      break;
    ...
    case 3:
      InsultCom = "Too good, jk";
      break;

    case 4:
      InsultCom = "This is easy mode...";
      break;

    case 5:
      InsultCom = "Julius...why did u make it so easy... -Aaryan";
      break;

    case 6:
      InsultCom = "Wow you're slow";
      break;

    default:
      break;
    }
    text(InsultCom, width/2, height/2-300);
    textSize(25);
    text("Press tab to go back to the home screen", width/2, 600);
  }
  void homeScreen()
